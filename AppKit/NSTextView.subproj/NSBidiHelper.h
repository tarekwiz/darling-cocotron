...
NSUInteger NSBidiHelperParagraph(NSInteger *baselevel, unichar *text, uint8_t *levels, NSUInteger textLevel);
...
void NSBidiHelperProcessLine(NSInteger baselevel, NSUInteger *glyphs, unichar *text, uint8_t *levels, NSInteger mirror, NSUInteger length);
